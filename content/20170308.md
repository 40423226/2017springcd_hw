...
<p>外加正三角形: <button onClick="lity('./../data/fourbar/solvespace_fourbar_triangle.png"><span class="glyphicon glyphicon-picture"></span> 尺寸圖</button> <button onClick="lity('./../data/fourbar/EXCEL_fourbar_triangle.png"><span class="glyphicon glyphicon-picture"></span> 路徑圖</button></p>